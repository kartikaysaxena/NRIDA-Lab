        ...
        <div className="flex flex-col items-center">
            <div className="max-w-full px-20 md:px-40 xl:px-80 pt-10 ">
                ...
                <div className="p-10 m-2 font-normal gap-4 text-xl grid grid-cols-2 ">
                    <div className="bg-white p-2 rounded-lg col-span-2 lg:col-span-1">
                    ...
                    <p>Phone: 0612-3028705, Mob: +91 8434081334</p> */}
                        <p class="mb-1 text-2xl">Sudhir Varma, Ph.D.</p>
                        <p class="mb-1 text-2xl">Assistant Professor</p>
                        <p class="mb-1 text-2xl">Department of Civil and Environmental Engineering</p>
                        <p class="mb-1 text-2xl">Indian Institute of Technology, Patna</p>
                        <p class="mb-1 text-2xl">Bihta, Bihar 801106</p>
                        <p class="mb-1 text-2xl">Email: svarma@iitp.ac.in, sudhirvarma5@gmail.com</p>
                        <p class="mb-1 text-2xl">Phone: 0612-3028705, Mob: +91 8434081334</p>
                        <br />
                    </div>
